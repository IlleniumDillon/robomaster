...
:nh_(nh), nh_private_(nh_private), got_circle_flag_(false) {
    ...
    odom_sub_ =
        nh_.subscribe<geometry_msgs::PoseStamped>("/airsim_node/drone_1/debug/pose_gt",1, &TrajectoryReplanNode::odomCallback,this);
...
void TrajectoryReplanNode::odomCallback(const geometry_msgs::PoseStampedConstPtr &msg) {
    odom_ = msg;
