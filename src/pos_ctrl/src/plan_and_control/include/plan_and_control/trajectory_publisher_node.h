...
private:
    ...
    ros::Publisher desiredPose_pub_, currentPose_pub_,velocity_pub;
    ros::Subscriber odom_sub_;
    ros::ServiceClient takeoff_client_;
    uav_msgs::DesiredStates cmd_;
    geometry_msgs::PoseStampedConstPtr odom_;
    geometry_msgs::PoseStamped desiredPose_, currentPose_;
    ros::Time prev_time_;

    //parameters for planner
    Eigen::Vector3d odom_pos_, odom_vel_,prev_pos_,current_pos;
