...
class POSCtrl
{
 private:
  ...
  ros::Subscriber desiredStates_sub_,circles_gt_suber;
  ...
  uav_msgs::DesiredStates desired_states_;
  ...
  void desiredStatesCallback(const uav_msgs::DesiredStates::ConstPtr& msg);
